...
- Configure cross-account access between dev (<DEV_ACCOUNT_ID>) and prod (<PROD_ACCOUNT_ID>)
...
- Support multi-tenancy (<tenant-a>, <tenant-b>, <tenant-c>) with service-specific configurations
